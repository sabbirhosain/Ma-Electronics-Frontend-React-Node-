            ...
            <div className="modal-dialog modal-lg">
                <form className="modal-content rounded-0">
                    <div className="modal-header">
                        <h2 className="modal-title" style={{ fontSize: '18px', fontFamily: 'Poppins, sans-serif' }} id="exampleModalLabel">Update Product</h2>
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="submit" className="btn btn-primary rounded-0 custom_btn">Update</button>
                    </div>
                </form>
            </div>
        </div>
...
export default Update_Product_Model