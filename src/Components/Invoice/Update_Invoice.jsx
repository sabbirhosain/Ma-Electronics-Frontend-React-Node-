              ...
              <div className="row justify-content-end mt-3">
                <div className="col-md-5">
                  <div className="row align-items-center mb-2">
                    ...
                    <div className="col-4 pe-1"><input type="text" value={invoice.total_price || ""} className="form-control rounded-0" readOnly disabled={loading} /></div>
                    <div className="col-2 ps-1"><input type="text" value={invoice.currency_type || ""} className="form-control rounded-0" readOnly disabled={loading} /></div>
                  </div>

                  <div className="row align-items-center mb-2">
                    <div className="col-6"><label className="form-label d-block text-end">Discount :</label></div>
                    <div className="col-4 pe-1"><input type="number" name='discount' value={invoice.discount || ""} onChange={handleChange} min='0' max='100' className="form-control rounded-0" disabled={loading} /></div>
                  ...
                  <div className="row align-items-center mb-2">
                    ...
                    <div className="col-6"><input type="text" name='grand_total' value={invoice.grand_total || ""} onChange={handleChange} className="form-control rounded-0" readOnly disabled={loading} /></div>
                  </div>
